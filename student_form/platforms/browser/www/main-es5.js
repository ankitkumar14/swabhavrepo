      ...
      _createClass(GetdataService, [{
        ...
        value: function addstudent(studentdata) {
          ...
          var promise = new Promise(function (resolve, reject) {
            _this3.http.post(_this3.api, studentdata).toPromise().then(function (res) {
              resolve();
            })["catch"](function (err) {
              console.log(err);
              reject(err);
        ...
        value: function deletestudent(id) {
          ...
          var promise = new Promise(function (resolve, reject) {
            _this4.http["delete"](url).toPromise().then(function (response) {
              resolve();
            })["catch"](function (err) {
              console.log(err);
              reject(err);
        ...
        value: function updateStudents(id, data) {
          ...
          return new Promise(function (resolve, reject) {
            _this6.http.put(_this6.api + "/" + id, data, {
              responseType: 'json'
            }).toPromise().then(function (response) {

...
const routes = [
    ...
    {
        path: 'saving',
        loadChildren: () => __webpack_require__.e(/*! import() | saving-saving-module */ "saving-saving-module").then(__webpack_require__.bind(null, /*! ./saving/saving.module */ "./src/app/saving/saving.module.ts")).then(m => m.SavingPageModule)
    },
    {
        path: 'expense',
        loadChildren: () => __webpack_require__.e(/*! import() | expense-expense-module */ "expense-expense-module").then(__webpack_require__.bind(null, /*! ./expense/expense.module */ "./src/app/expense/expense.module.ts")).then(m => m.ExpensePageModule)
    },
    {
        path: 'history',
...
/* harmony import */ var _my_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./my.service */ "./src/app/my.service.ts");
...
MyService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
module.exports = __webpack_require__(/*! D:\swabhav\expense_tracker\src\main.ts */"./src/main.ts");
